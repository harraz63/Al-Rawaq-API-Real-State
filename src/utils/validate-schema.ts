...
export const propertySchema = z.object({
    ...
    price: z.preprocess(
        (val) => Number(val),
        z.number({ required_error: "السعر مطلوب" }).positive("السعر يجب أن يكون رقمًا موجبًا")
    ),
    ...
    location: z.preprocess(
        ...
        z.object({
            ...
            governorate: z.enum([
                ...
                "المنوفية", "البحيرة", "كفر الشيخ", "سوهاج", "أسيوط",
                "أسوان", "الأقصر", "دمياط", "الفيوم", "بورسعيد", "الإسماعيلية"
    ...
    images: z.array(z.string().url()).min(1, "يجب رفع صورة واحدة على الأقل").optional(),
    ...
    paymentMethod: z.enum(["cash", "installments", "bank-financing"]).default("cash"),
